              ...
              <div className="flex flex-col items-start gap-[18px]">
                ...
                <div className="flex flex-col items-start gap-6">
                  ...
                  <p className="text-start max-w-[518px] text-common-white-800 font-light text-sm lg:text-lg">
                    Deixe os palpites de lado e comece a apostar com análises precisas. A Betstats
                    traz a ciência para suas apostas, combinando análise detalhada e dados precisos
                    para uma experiência de apostas mais inteligente e lucrativa.
                  </p>
                </div>
